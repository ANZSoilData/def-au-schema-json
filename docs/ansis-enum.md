...
| ID/JSON Value | Preferred Label |
| ---------- | --------------- |
| x:colour-munsell | Munsell Colour System \[ _Munsell Color (Firm). (2010). Munsell soil color charts: with genuine Munsell color chips. Grand Rapids, MI :Munsell Color,_ \] |
| x:colour-japan | Japanese Soil Color Charts \[ _Takehara, H., Oyama, M. (1970). Standard Soil Color Charts. Japan: Japanese Ministry of Agriculture and Forestry, Research Council for Agriculture, Forestry and Fisheries._ \] |
