...
| isSampleOf | 0..1 | object; null | template |
| depthFreeWater | 0..1 | object | Depth to free water at the site of soil observation, either above or below the soil surface, excluding litter and living vegetation. Positive values indicate water above the soil surface. Negative values indicate water below the soil surface. |
| designSite | 0..1 | object | overall design of sampling at the site e.g. ASLS|grid|transect |
| designSurvey | 0..1 | object | overall design of soil or landscape survey e.g. free|grid|stratified|miscellaneous |
| disturbance | 0..1 | object | disturbance of site |
...
| heightDrainage | 0..1 | object | vertical extent of drainage |
| locationInElement | 0..1 | object | location within landform element |
| locationInToposequence | 0..1 | object | location within a toposequence |
...
| relatedProfile | 0..* | object | Link to a soil profile related to this context. |
| relatedProject | 1..* | object | link to project that supported this activity |
...
| @id | 0..1 | string | An HTTP URI uniquely identifying the object as a Linked Data resource. Dereferencing the URI should, but may not, lead to a JSON or HTML representation of the resource. |
| @type | 1..1 | string | A compact URI uniquely identifying the type of the object according to the OWL/RDF domain model. |
| conditionWhenDry | 0..1 | object | surface condition when dry |
...
| @type | 1..1 | string | A compact URI uniquely identifying the type of the object according to the OWL/RDF domain model. |
| type | 0..1 | object | type of ansis soil entity |
| distance | 1..1 | object | spatial separation of objects |
| depth | 1..1 | object |  |
| confidence | 0..1 | string | confidence in assessment |
| relatedSample | 0..1 | object | link to a sample related to this context |
| relatedSoilBody | 0..1 | object | link to a soil body related to this context |
...
| @id | 0..1 | string | An HTTP URI uniquely identifying the object as a Linked Data resource. Dereferencing the URI should, but may not, lead to a JSON or HTML representation of the resource. |
| @type | 1..1 | string | A compact URI uniquely identifying the type of the object according to the OWL/RDF domain model. |
| actsOnProperty | 0..1 | object; null | Relation between an Actuation and the property of a FeatureOfInterest it is acting upon. |
...
| @type | 1..1 | string | A compact URI uniquely identifying the type of the object according to the OWL/RDF domain model. |
| abundance | 1..1 | object | abundance of items |
| material | 1..1 |  | material or composition of entity or element |
...
| -------- | ----------- | ---- | ----------- |
| @type | 1..1 | string | A compact URI uniquely identifying the type of the object according to the OWL/RDF domain model. |
| classificationFamilyA1texture | 0..1 | string | family criteria - A1 horizon texture |
| classificationFamilyA1thickness | 0..1 | string | family criteria - A1 horizon thickness |
| classificationFamilyBtexture | 0..1 | string | family criteria - B horizon texture |
| classificationFamilyDepth | 0..1 | string | family criteria - Soil depth |
| classificationFamilyGravel | 0..1 | string | family criteria - Gravel of the surface and A1 horizon |
| classificationGreatGroup | 0..1 | string | soil classification - Great group |
| classificationOrder | 1..1 | string | soil classification - Order |
| classificationSubGroup | 0..1 | string | soil classification - Subgroup |
