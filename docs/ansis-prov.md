...
| scopedIdentifier | 0..1 |  | [base:ScopedIdentifier](./ansis-base#basescopedidentifier) |  | An identifier for a site, sample or other entity scoped to the authority that assigned the identifier. |
